...
define gui.accent_color = '#FCCA46'
...
transform bg_with_zoom:
    "bg digitalspace0.png"
    truecenter zoom 0.7 alpha 0.2
    linear 1 zoom 1 alpha 1

define gui.main_menu_background = bg_with_zoom
define gui.game_menu_background = "bg digitalspace0.png"

transform logo_floating:
    "DigiwarpedLogo_white.png"
    xalign 0.5
    yalign 0.1
...
transform matrix:
    contains:
        ...
        zoom renpy.random.random()
        alpha .7
        "1.png"
        linear renpy.random.randint(1, 8) ypos 1.0
        repeat
    contains:
        subpixel True
        yalign -1.0
...
## side of the screen.
define gui.navigation_xpos = 0.43
